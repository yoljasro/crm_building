...
export default function PropertyDetailsPage() {
    ...
    const fetchDetails = async () => {
        ...
        try {
            ...
            if (objJson.success) {
                const foundObj = objJson.data.find((o: any) => o.id === params.id);
                if (foundObj) {
                    setObject(foundObj);
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="relative h-[420px] rounded-[32px] overflow-hidden shadow-2xl group bg-gray-100 border border-gray-100">
                        <img
                            ...
                            onError={(e) => { (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=1000&auto=format&fit=crop"; }}
                        />
                    ...
                    {/* Image Gallery - agar bir nechta rasm bo'lsa */}
                        ...
                        <div className="flex gap-3 overflow-x-auto pb-2">
                            {object.images.map((img, idx) => (
                                <img
                                    ...
                                    className="w-24 h-24 object-cover rounded-2xl flex-shrink-0 cursor-pointer border-2 border-transparent hover:border-blue-500 transition-all"
